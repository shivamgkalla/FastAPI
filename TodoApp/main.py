...
app = FastAPI(title="TodoApp v1.0")
...
# Docker layers caching test #

@app.get("/docker_caching")
def docker_caching_for_pip_requirements():
    return {"status": "Check manually in the Actions."}
